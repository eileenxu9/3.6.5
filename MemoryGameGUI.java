...
public class MemoryGameGUI extends JFrame 
{
  ...
  { 
    ...
    JOptionPane.showMessageDialog(this, "Welcome to the Memory Game " + name + "!", "Welcome", JOptionPane.PLAIN_MESSAGE);
    JOptionPane.showMessageDialog(this, "Memorize the sequence shown on the screen. It gets harder as you continue. Guess correctly 10 times and you win. Guess wrong 3 times and you lose.", "Instructions", JOptionPane.PLAIN_MESSAGE);
    return name;
  }

  /**
   * Asks the user what level they want to play
   * 
   * @return level chosen by user
   */
  public Object chooseLevel()
  {
    Object[] possibleValues = { "Easy", "Medium", "Hard" };
    Object selectedValue = JOptionPane.showInputDialog(null, "Choose a level of play", "Levels", JOptionPane.INFORMATION_MESSAGE, null, possibleValues, possibleValues[0]);
  ...
  public void createBoard(int numButtons, Boolean playRandom)
  {
    ...
    for (int i = 0; i < numButtons; i++) {
      ...
      gameButtons[i].setBackground(Color.YELLOW);
  ...
  public String playSequence(String[] sequence, double delay)
  {
    ...
    for (int i = 0; i < sequence.length; i++ )
    {
      ...
      gameButtons[buttonNum].setBackground(new Color(255, 255, 0));
      ...
      gameButtons[buttonNum].setBackground(Color.YELLOW);
  ...
  /**
   * Show the current diffficulty.
   * 
   * @param difficulty difficulty level
   */
  public void showDifficulty(int difficulty)
  {
    JOptionPane.showMessageDialog(this, "You are on difficulty level: " + difficulty, "Difficulty Level", JOptionPane.PLAIN_MESSAGE);
  }
  ...
  /**
   * Shows a message that the user won the game
   */
  public void win(String name)
  { 
    JOptionPane.showMessageDialog(this, "You win " + name + "!", "Congratulations", JOptionPane.PLAIN_MESSAGE);
  }

  /**
   * Shows a message that the user lost the game
   */
  public void lose(String name)
  { 
    JOptionPane.showMessageDialog(this, "You lose " + name + "!", "Do better", JOptionPane.PLAIN_MESSAGE);
  }
}
